...
let carouselInterval = setInterval(nextPhoto, 5000);
...
if (imageContainer) {
    ...
    imageContainer.addEventListener('mouseleave', () => {
        carouselInterval = setInterval(nextPhoto, 5000);
    });
}

// Click on indicators to change photo
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        // Create mailto link
        const mailtoLink = `mailto:sonukshaureya12345@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
document.addEventListener('DOMContentLoaded', () => {
    // Project cards removed - no longer needed
});
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        const mailtoLink = `mailto:sonukshaureya12345@gmail.com?subject=${encodeURIComponent(`Portfolio Contact: ${subject}`)}&body=${encodeURIComponent(`
Hello Sonu,
...
// Project Filtering System - Removed as projects are deleted
function initializeProjectFilters() {
    // Project filters removed - no longer needed
}
...
function createSkillChart() {
    ...
    // Custom skill data for Sonu Kumar
const skills = [
...
console.log('%cDeveloped by Sonu Kumar', 'color: #3498db; font-weight: bold; font-size: 14px;');
